	...
	class WP_MANGA_SLIDER extends WP_Widget {
		function __construct() {
			$widget_ops = array(
				...
				'description' => esc_html__( 'Manga slider', WP_MANGA_TEXTDOMAIN )
			);
		...
		function form( $instance ) {
			...
			$slider_dots          = ! empty( $instance['slider_dots'] ) ? $instance['slider_dots'] : 'on';
			...
			<p>
                <label for="<?php echo $this->get_field_id( 'slider_dots' ); ?>"><?php echo esc_html__( 'Slider Dots (Navigation)', WP_MANGA_TEXTDOMAIN ); ?>
                    : </label>
                <select class="widefat" id="<?php echo $this->get_field_id( 'slider_dots' ); ?>" name="<?php echo $this->get_field_name( 'slider_dots' ); ?>">
					<option value="off" <?php echo $slider_dots == 'off' ? 'selected="selected"' : ''; ?>><?php echo esc_html__( 'Hide', WP_MANGA_TEXTDOMAIN ); ?></option>
                    <option value="on" <?php echo $slider_dots == 'on' ? 'selected="selected"' : ''; ?>><?php echo esc_html__( 'Show', WP_MANGA_TEXTDOMAIN ); ?></option>
                </select>
            </p>
		...
		function update( $new_instance, $old_instance ) {
			...
			$instance['slider_dots']       = strip_tags( $new_instance['slider_dots'] );
		...
		function widget( $args, $instance ) {
			...
			$slider_dots = empty( $instance['slider_dots'] ) ? 'on' : $instance['slider_dots'];
			$classes .= ' dots-' . $slider_dots;
