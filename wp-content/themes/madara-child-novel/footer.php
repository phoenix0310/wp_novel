                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="copyright">
								<?php
									...
									if ( $madara_copyright != '' ) {
										...
										echo '<p>' . sprintf(esc_html__( '&copy; %s Madara Inc. All rights reserved', 'madara-child' ), date('Y')) . '</p>';
									}
								?>
                            </div>
                            ...
                            <div class="languages">
                                <span class="title"><?php esc_html_e('Language:','madara-child');?></span> <?php pll_the_languages( ['dropdown'=>1] );?>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
