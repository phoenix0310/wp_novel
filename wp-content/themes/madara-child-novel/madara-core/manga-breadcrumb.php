                    ...
                    <div class="col-md-12">
						...
						<?php if ( ! is_manga_single() && ! is_manga_reading_page() && $madara_genres_block == 'on' && ! is_manga_search_page() ) {
							...
							//genre query
								//get queried object
								$object = $wp_query->queried_object;
								$queried_genre = $object ? $object->name : '';
							$genre_args = array(
                                                        ...
                                                        <ul class="list-unstyled">
															<?php
																foreach ( $genres as $genre ) {
																	?>
                                                                    <li class="col-6 col-sm-4 col-md-2 <?php if ($genre->name == $queried_genre) {echo 'active';}?>">
