		...
		if ($madara->getOption('font_using_custom', 'off') == 'on') {
			...
			if ($mainFontFamily != '') {
				...
				if ($mainFontName != '') {
					$custom_css .= '
							body{
								font-family: "' . esc_html($mainFontName) . '", sans-serif;
							}';
				}
				;
			}
				...
				if ($headingFontName != '') {
					...
					$custom_css .= '
							h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6, h1 a, h2 a, h3 a, h4 a, h5 a, h6 a, .h1 a, .h2 a, .h3 a, .h4 a, .h5 a, .h6 a, .heading a, .font-heading, .widget-title a
							 {
								font-family: "' . esc_html($headingFontName) . '", sans-serif;
							}';
				}
			}
			...
			if ($metaFontFamily != '') {
				...
				if ($metaFontName != '') {
					...
					$custom_css .= ' .font-meta, .posts-date, time, .popular-slider .slider__container .slider__item .slider__content .slider__content_item .chapter-item .chapter a {
								font-family: "' . esc_html($metaFontName) . '", sans-serif;
							}';
				}
			}

			if ($mainNavigationFont != '') {
				$custom_css .= '.main-navigation .main-menu a, .second-menu a, .site-header .c-sub-header-nav .c-sub-nav_wrap .c-modal_item .c-user_item span, .site-header .c-sub-header-nav .c-sub-nav_wrap .c-modal_item .c-user_item .c-user_menu a, .site-header .c-sub-header-nav .c-sub-nav_wrap .c-modal_item .btn-active-modal, .site-header .main-navigation.style-1 .search-navigation .search-navigation__wrap .link-adv-search a {font-family: "' . esc_html($mainNavigationFont) . '", sans-serif}';
			}
