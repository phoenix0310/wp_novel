 ...
 * @since 1.0.0
 */
class Elementor_Manga_Slider extends Elementor_Madara_Widget {
	...
	public function get_title() {
		return esc_html__( 'Manga Slider', 'madara' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'number_to_show',
			[
				'label' => esc_html__( 'Number of items to show', 'madara' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'placeholder' => '3',
				'min' => 1,
				'max' => 5,
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'style-3' => esc_html__( 'Style 3', 'madara' ),
				],
				'default' => 'style-1',
			]
		);
		...
		$this->add_control(
			'dots',
			[
				'label' => esc_html__( 'Slider Dots (Navigation)', 'madara' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'options' => [
	...
	protected function render() {
		...
		<div class="manga-slider <?php echo implode(" ", $classes ); ?>" data-autoplay="<?php echo esc_attr($autoplay);?>" data-style="<?php echo esc_attr( $data_style ); ?>" data-count="<?php echo esc_attr( $number_to_show ); ?>">
	...
	protected function content_template() {
		...
		?>
		<#
		widget_name = '<?php echo $this->get_name();?>';
		autoplay = settings.autoplay;
		data_style = settings.style;
		classes = widget_name + ' ' + data_style + ' dots-' + settings.dots;
		data_style = data_style == 'style-3' ? 'style-1' : data_style;
		number_to_show = settings.number_to_show;		
		number_of_post = settings.number_of_post;
