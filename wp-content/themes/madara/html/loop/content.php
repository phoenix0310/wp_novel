<?php
	...
	$archive_content_columns = intval(get_query_var( 'archive_content_columns', Madara::getOption( 'archive_content_columns', 3 ) ));
	$archive_post_excerpt    = Madara::getOption( 'archive_post_excerpt', 'on' );

	$archive_content_columns = $archive_content_columns ? $archive_content_columns : 3;
